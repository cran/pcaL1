...
int initialize(ENTITYINFOptr entityinfo, PROBLEMINFOptr probleminfo);
int polarityChk(ENTITYINFOptr entityinfo, PROBLEMINFOptr probleminfo);
int ChkConvergence(PROBLEMINFOptr probleminfo, ENTITYINFOptr entityinfo);
int dgesvd_pcal1 (char jobu, char jobvt, int m, int n, double *A, int lda, double *S, double *VT, int ldu, double *Umat, int ldvt, double *work, int lwork); /* SVD */
